...
class VendorAdminOrderItemDetailsScreenState
  ...
  Widget build(BuildContext context) {
    ...
    final currency = widget.order.currencyCode ?? Provider.of<AppModel>(context, listen: false).currencyCode;
    final currencyRate =
    (widget.order.currencyCode?.isEmpty ?? true) ? Provider.of<AppModel>(context, listen: false).currencyRate : null;
              ...
              Row(
                children: [
                  ...
                  Builder(builder: (_) {
                    ...
                    return Text(
                      PriceTools.getCurrencyFormatted(
                          widget.order.totalTax, currencyRate, currency: currency)!,
                    );
                  }),
                ],
              ),
              ...
              Row(
                children: [
                  ...
                  Builder(builder: (_) {
                    ...
                    return Text(
                      PriceTools.getCurrencyFormatted(
                          widget.order.total, currencyRate,currency: currency)!,
                      style: TextStyle(
                        fontSize: fontSize,
                        fontWeight: FontWeight.bold,
                      ),
              ...
              Row(
                children: [
                  ...
                  Builder(builder: (_) {
                    ...
                    return Text(
                      PriceTools.getCurrencyFormatted('0.0', currencyRate,currency: currency)!,
                      style: TextStyle(
                        fontSize: fontSize,
                        fontWeight: FontWeight.bold,
                      ),
